...
document.body.childeren[5].children[0].innerText = "all about document"
...
let emaialInput = document.querySelector('input')
...
allTopics.forEach((ele) => ele.innerText)
...
console.log(`The total number of image element is ${allImg.length}`)

// 16. Select all the `p` element and store in `allPElement`
let allPElement = documnet.querySelectorAll('p')
...
let firstTest =documnet.getElementById('test')
